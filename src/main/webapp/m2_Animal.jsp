...
<html>
    ...
    <div>
        ...
        <%
            jb.connect();
            long aux = java.lang.Long.parseLong(request.getParameter("idanimal"));
            ...
            String[] valori = {tip, familie, specie, sex, nume};
            String[] campuri = {"tip", "familie", "specie", "sex", "nume"};
            jb.modificaTabela("animale", "idanimal", aux, campuri, valori);
            jb.disconnect();
        %>
